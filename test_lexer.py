...
def test_simple_object():
    ...
    assert tokens[2].type == lexer.TokenType.DOUBLE_QUOTE
    assert tokens[3].type == lexer.TokenType.TEXT
    assert tokens[4].type == lexer.TokenType.DOUBLE_QUOTE
    assert tokens[5].type == lexer.TokenType.SEMI_COLON
    assert tokens[6].type == lexer.TokenType.NUMBER
    assert tokens[7].type == lexer.TokenType.SKIP
    assert tokens[8].type == lexer.TokenType.CLOSED_CURLY_BRACKET
